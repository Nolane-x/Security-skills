...
- `type-confusion-analysis` — the thirty-first profile, adding logical-object/storage provenance, logical and actual dynamic type identity, type-identity mechanism/generation, representation/layout and active-member generations, producer/transition and cast/downcast/variant binding, validator/check generation, consumer interpreted-type and field/dispatch/operation identity, effective wrong-type capability and bounded receipt/result binding, deterministic benign review cases, counterfactual type controls, alternative-explanation elimination, and TCF0–TCF5 evidence ceilings.
- `jit-invariant-analysis` — the thirty-second profile, adding runtime/build and language-semantics provenance, program/input and compilation-unit generations, execution-tier and optimized-code generations, optimization-pass identity, feedback/profile and speculative-dependency generations, guard/invalidation/watchpoint binding, OSR/inlining/specialization state, deopt trigger and frame-state reconstruction, baseline/reference-to-optimized semantic-consumer binding, effective optimized-divergence capability and bounded receipt/result binding, deterministic benign review cases, counterfactual JIT controls, alternative-explanation elimination, and JIT0–JIT5 evidence ceilings.
- `firmware-update-trust-chain-analysis` — the thirty-third profile, adding device/revision and update-attempt provenance, signer/root policy generations, authenticated bundle and canonical-manifest binding, hardware/version/rollback-domain identity, component-set and transformed/delta artifact lineage, staging and activation transaction generations, rollback/version-state commit ordering, recovery/fallback policy generations, final update-state consumer and effective update-trust capability binding, deterministic benign review cases, counterfactual update controls, alternative-explanation elimination, and FWU0–FWU5 evidence ceilings.
- `nonce-and-randomness-lifecycle-analysis` — the thirty-fourth profile, adding value-class/property and security-scope provenance, generator implementation/instance/state generations, entropy/seed/reseed epochs, process/fork/snapshot/restart generations, counter namespace/reservation and synchronization binding, persistence checkpoint ordering, raw-to-transformed final-value identity, consumer/construction binding, effective randomness-lifecycle capability and bounded receipt/result binding, deterministic benign review cases, counterfactual randomness controls, alternative-explanation elimination, and NRL0–NRL5 evidence ceilings.
...
The type-confusion evidence ladder is likewise causal: TCF0 maps type-identity mechanisms, logical-object/storage generations, layouts, producers/transitions, validators, casts, active members, and consumers; TCF1 observes a repeatable type/tag/layout/member/generation divergence without final wrong-type consumer acceptance; TCF2 demonstrates a controlled dynamic-type, active-member, handle-table-type, validator, or representation invariant mismatch; TCF3 requires inert or read-only wrong-field interpretation or wrong-class/inert dispatch by the final consumer; TCF4 requires a bounded reversible synthetic canary, fake object or handle table, inert dispatch target, read-only shadow object, or owner-controlled marker bound to the exact object/type/representation/consumer tuple; and TCF5 additionally requires complete object/storage/type-generation provenance, the first type-identity/representation divergence, transition/validator binding, meaningful counterfactual type controls, eliminated alternative explanations, receipt/result binding, and remediation replay. Casts, unchecked casts, stale tags, sanitizer reports, assertions, crashes, wrong-field observations, wrong dispatch classes, or synthetic markers cannot skip missing causal bindings.

The JIT-invariant evidence ladder is likewise causal: JIT0 maps runtime/build, tiers, compilation units, feedback, optimization passes, speculative invariants, guards, invalidation, OSR/inlining, deopt, and semantic consumers; JIT1 observes a repeatable optimized-only state, feedback, dependency, guard, invalidation, OSR, or deopt divergence without deterministic semantic mismatch; JIT2 demonstrates a controlled speculative, guard, dependency, invalidation, OSR-state, or deopt-state invariant mismatch while preserving the intended optimization path; JIT3 requires a deterministic wrong value, wrong branch, stale logical state, or incorrect deopt reconstruction observed by a read-only/mock semantic consumer while baseline/reference execution remains correct; JIT4 requires a bounded reversible synthetic canary, inert state mutation, read-only shadow result, bounded assertion, or owner-controlled marker bound to the exact program/tier/code/pass/assumption/guard/deopt/consumer tuple; and JIT5 additionally requires complete build/program/compilation provenance, first-invalid-assumption or first-unsound-transform trace, tier/pass confirmation, dependency/invalidation proof, deopt/OSR state where relevant, meaningful counterfactual JIT controls, eliminated alternative explanations, receipt/result binding, and remediation replay. Crashes, assertions, sanitizer reports, optimization logs, different machine code, stale-looking feedback, or synthetic markers cannot skip missing causal bindings.

The firmware-update evidence ladder is likewise causal: FWU0 maps update paths, bundle formats, roots/signers, manifests, hardware/version policy, rollback domains, component transforms, staging, activation, and recovery; FWU1 observes a repeatable bundle, manifest, component, hardware, version, staging, activation, rollback, or recovery identity/generation divergence without wrongful final update-state acceptance; FWU2 demonstrates a controlled signer, manifest-binding, hardware, version, rollback, component-set, transform/base, staging, activation, or recovery invariant mismatch; FWU3 requires inert or read-only final update-state acceptance of the wrong component, delta-base generation, version generation, hardware target, policy generation, transformed artifact, or partial component set; FWU4 requires a bounded reversible staged-slot marker, fake component-set activation, reversible version-state transition, or read-only recovery result bound to the exact device/path/bundle/manifest/component/transaction tuple; and FWU5 additionally requires complete device/path/bundle/signer/manifest/component/version/rollback/staging/activation/recovery provenance, the first broken trust binding, meaningful counterfactual update controls, eliminated alternative explanations, receipt/result binding, and remediation replay. Downloads, valid signatures, parser success, update success flags, version strings, slot writes, recovery entry, crashes, or synthetic markers cannot skip missing causal bindings.

The nonce/randomness-lifecycle evidence ladder is likewise causal: NRL0 maps value classes, security requirements/scopes, generators, seed/reseed paths, counters, persistence, fork/restart behavior, transforms, and consumers; NRL1 observes a repeatable generator, seed, counter, persistence, fork/restart, reservation, transform, or scope divergence without a forbidden final-value relation; NRL2 demonstrates a controlled uniqueness, non-repetition, freshness, unpredictability, collision, reservation, or persistence lifecycle mismatch; NRL3 requires a mock/read-only consumer to accept values whose reuse, collision, or prediction relation violates the bound security property in the same required scope; NRL4 requires a bounded reversible synthetic construction effect or inert protocol-state marker bound to the exact lifecycle tuple; and NRL5 additionally requires complete generator/seed/scope/lifecycle/counter/persistence/transform/consumer provenance, the first invalid lifecycle transition, meaningful counterfactual randomness controls, eliminated alternative explanations, receipt/result binding, and remediation replay. RNG API names, weak-looking seeds, duplicate logs, small samples, statistical tests, counter values, crashes, or synthetic markers cannot skip missing causal bindings.

This raises the current registry from eight Wave 8 profiles to **thirty-four CI-enforced profiles** while keeping the Wave 8 history intact. Wave 10 profiles apply the same common operator-depth contract and add domain-specific causal reasoning rather than payload volume or checklist length.
